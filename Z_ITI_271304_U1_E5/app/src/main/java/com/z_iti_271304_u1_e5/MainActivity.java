package upvictoria.pm_sep_dic_2024.iti_271164.e1u1.z_iti_271304_u1_e5;
...
public class MainActivity extends AppCompatActivity {
    ...
    // Método para obtener encabezados de columna (Ejemplo: B'C', BC', etc.)
    ...
    // Método para obtener encabezados de fila (Ejemplo: A', A, etc.)
